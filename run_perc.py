...
parser.add_argument('--interArrivalTime', type=float, default=0.005)
...
run_perc = "sudo " + moonGen + " " + mainFile + " " + mode + " " + cdfFile + " " + str(scaling) + " " + str(interArrivalTime) + " "+ str(numFlows)  + " > " + tmpFile
print run_perc
